...
const TableSat2 = () => {
    ...
    const fetchTable = async () => {
      try {
        const response = await fetch(
          "http://play-cricket.com/api/v2/league_table.json?division_id=126807&api_token=13776c06d7c5517b705e9926873b8cec"
        );
        if (!response.ok) {
  ...
  return (
    <div className="bg-white text-black p-6 rounded-lg shadow-lg">
      <h2 className="text-xl font-bold mb-4 text-center">TVCL Division 6A League Table</h2>
